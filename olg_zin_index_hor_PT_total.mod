...
var A, b, bd, co, cy, g, k, md, m, mu, muy, pi, pro, R, rm, rn, ri, v, q, z, out, eco, w, rf, rk, btotd, btot, bi, bid, utility, g_ratio, irp, piind;
...
//Indexed inflation
piind =( (1+pstar)^20 )*( (1+q)/(1+q(-1)) )*( (1+z)/(1+z(-1)) )^(1/2);
...
t = 0.11;
tk = 2.3*t;
end;vcov = [3.100000e-003 0 0 0; 0 1.100000e-004 0 0; 0 0 1.100000e-004 0; 0 0 0 1.100000e-004]; 
