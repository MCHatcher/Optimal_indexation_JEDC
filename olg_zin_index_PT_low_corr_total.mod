...
var A, b, bd, co, cy, g, k, md, m, mu, muy, pi, pro, R, rm, rn, v, q, out, eco, w, rf, rk, btotd, btot, bi, bid, utility, g_ratio, ri, irp, piind;
...
vcov = [3.100000e-003 0 0; 0 1.100000e-004 5.500000e-005; 0 5.500000e-005 1.100000e-004]; 
